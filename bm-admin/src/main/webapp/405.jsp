...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Method Not Allowed - XinyinTech</title>
        ...
        <section class="section">
            <div class="container">
                <div class="error-page">
                    ...
                    <p class="error-description muted">A request was made of a page using a request method not supported by that page</p>
                    <form >
