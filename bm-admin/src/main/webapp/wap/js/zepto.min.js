...
var Zepto = function() {
    ...
    return G.matches = function(t, e) {
        ...
        var r, i, a;
        return k.test(t) && (r = j(A.createElement(RegExp.$1))), r || (t.replace && (t = t.replace(F, "<$1></$2>")), e === E && (e = $.test(t) && RegExp.$1), e in X || (e = "*"), a = X[e], a.innerHTML = "" + t, r = j.each(D.call(a.childNodes), function() {
            a.removeChild(this)
        ...
        var r;
        if (!t) return G.Z();
        if ("string" == typeof t) if (t = t.trim(), "<" == t[0] && $.test(t)) r = G.fragment(t, RegExp.$1, n), t = null;
        else {
            ...
            else if ($.test(t)) r = G.fragment(t.trim(), RegExp.$1, n), t = null;
            else {
                if (n !== E) return j(n).find(t);
                r = G.qsa(A, t)
            }
        ...
        ready: function(t) {
            return B.test(A.readyState) && A.body ? t(j) : A.addEventListener("DOMContentLoaded", function() {
                t(j)
            }, !1), this
        },
        get: function(t) {
    ...
    }), G.Z.prototype = d.prototype = j.fn, G.uniq = N, G.deserializeValue = w, j.zepto = G, j
}();
...
function(t) {
    ...
    S.href = window.location.href, t.active = 0, t.ajaxJSONP = function(e, n) {
        ...
        r(u), u.crossDomain || (n = y.createElement("a"), n.href = u.url, n.href = n.href, u.crossDomain = S.protocol + "//" + S.host != n.protocol + "//" + n.host), u.url || (u.url = window.location.toString()), (i = u.url.indexOf("#")) > -1 && (u.url = u.url.slice(0, i)), h(u);
        var d = u.dataType,
            v = /\?.+=\?/.test(u.url);
